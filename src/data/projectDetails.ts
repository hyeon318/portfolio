...
export const projectData: Record<string, ProjectDetailData> = {
  ...
  anytoon: {
    ...
    reflection:
      ...
      "이를 해결하기 위해 기존 팀이 사용하던 라이브러리 환경을 존중하면서 <strong>Guava 캐싱</strong>을 적용했고, 초기 평균 4초 걸리던 응답 속도를 1초로 단축했으며, 이후 추가 최적화를 통해 <strong>메인 컨텐츠 260개를 0.5초 이내로 노출</strong>할 수 있었습니다.<br/>" +
