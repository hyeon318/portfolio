          ...
          <div className="flex items-center space-x-10">
            {navigation.map((item, index) => (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
              >
                <span className="font-mono text-sm text-accent mr-3 opacity-70 group-hover:opacity-100 transition-opacity">
                  0{index + 1}.
                </span>
            ...
            {/* Social Links */}
            <div className="flex items-center space-x-5 ml-12 pl-8 border-l border-border/50">
